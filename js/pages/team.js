  ...
  showEditModal(employee, container) {
    ...
    modal.innerHTML = '' +
      '<div class="emp-modal-header">' +
        '<span class="emp-modal-title">' + (isNew ? 'Add Employee' : 'Edit Employee') + '</span>' +
        '<button class="emp-modal-close" id="team-modal-close">&times;</button>' +
      '</div>' +
      '<div class="emp-modal-body">' +
        ...
        '<div class="emp-modal-section">' +
          '<div class="emp-modal-section-title">Banking</div>' +
          '<div class="fury-form-group">' +
        ...
        '<div class="emp-modal-section">' +
          '<div class="emp-modal-section-title">Contract & Rate</div>' +
          '<div class="fury-form-row">' +
            '<div class="fury-form-group">' +
      ...
      '<div class="emp-modal-footer">' +
        '<button class="fury-btn-secondary" id="team-modal-cancel">Cancel</button>' +
